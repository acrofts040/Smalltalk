...
(class NatNonzero
    ...
    (method sdivmod:with: (n aBlock)
      ...
      ((Q' isZero) ifTrue:ifFalse:
        {(set Q q0)}
        {(set Q ((Q' timesBase) + q0))})
     
      (aBlock value:value: (Natural fromSmall: Q) r))
...
;; printrep tests for multiplying nat * 0
;(((Natural fromSmall: 0) * (Natural fromSmall: 0)) printrep)   ; 0 * 0
;(((Natural fromSmall: 0) * (Natural fromSmall: 1)) printrep)   ; 0 * 1
;(((Natural fromSmall: 1) * (Natural fromSmall: 0)) printrep)   ; 1 * 0
;(((Natural fromSmall: 0) * (Natural fromSmall: 10)) printrep)  ; 0 * 10
...
;; printrep tests for multiplying nat * nat
;(((Natural fromSmall: 1) * (Natural fromSmall: 1)) printrep)     ; 1 * 1
;(((Natural fromSmall: 1) * (Natural fromSmall: 2)) printrep)     ; 1 * 2
;(((Natural fromSmall: 2) * (Natural fromSmall: 1)) printrep)     ; 2 * 1
;(((Natural fromSmall: 27) * (Natural fromSmall: 1)) printrep)    ; 27 * 1
;(((Natural fromSmall: 1) * (Natural fromSmall: 27)) printrep)    ; 1 * 27
;(((Natural fromSmall: 2) * (Natural fromSmall: 27)) printrep)    ; 2 * 27
;(((Natural fromSmall: 12) * (Natural fromSmall: 12)) printrep)   ; 12 * 12
;(((Natural fromSmall: 122) * (Natural fromSmall: 227)) printrep) ; 122 * 227


;; printrep tests for sdiv:
(((Natural fromSmall: 0) sdiv: 0) printrep)   ; 0 / 0   = 0
(((Natural fromSmall: 0) sdiv: 1) printrep)   ; 0 / 1   = 0
(((Natural fromSmall: 0) sdiv: 194) printrep) ; 0 / 194 = 0

(((Natural fromSmall: 1) sdiv: 10) printrep)  ; 1 / 10  = 0
(((Natural fromSmall: 1) sdiv: 16) printrep)  ; 1 / 16  = 0
(((Natural fromSmall: 15) sdiv: 10) printrep) ; 15 / 10 = 1
(((Natural fromSmall: 16) sdiv: 10) printrep) ; 16 / 10 = 1
(((Natural fromSmall: 25) sdiv: 10) printrep) ; 25 / 10 = 2
;(((Natural fromSmall: 16) sdiv: 1) printrep) ; 16 / 1  = 16
...
((Natural fromSmall: 16) smod: 1)  ; 16 % 1  = 16
((Natural fromSmall: 16) smod: 1)  ; 16 % 0  = error
